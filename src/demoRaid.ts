...
const keyframes: Keyframe[] = [
  ...
  cam('k7', 43, L(-24, -22), 19.1, 50, -10, 'At the guest house, the courier Abu Ahmed al-Kuwaiti opens fire and is killed', { sensor: 'thermal' }),
  ...
  cam('k11', 65, L(12, 17), 19.5, 50, 60, 'Third floor: Osama bin Laden, unarmed, is killed — "Geronimo, EKIA" is relayed back', { sensor: 'nvg' }),
  ...
  cam('k14', 94, HELO1_LZ, 17.8, 50, 15, 'Before leaving, the team destroys the damaged helicopter to protect its technology', { sensor: 'thermal' }),
