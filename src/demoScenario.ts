 ...
 * broke the assault in about four hours; no US casualties, one SDF fighter wounded.
 */
...
export const DEMO_ROSTER: RosterEntry[] = [
  ...
  { id: 'r_m777', name: 'M777 howitzer battery', type: 'artillery', faction: 'United States', wikiTitle: 'M777 howitzer' },
  { id: 'r_f15', name: 'F-15E Strike Eagle', type: 'air', faction: 'United States', wikiTitle: 'McDonnell Douglas F-15E Strike Eagle' },
  { id: 'r_f22', name: 'F-22 Raptor', type: 'air', faction: 'United States', wikiTitle: 'Lockheed Martin F-22 Raptor' },
...
const COLUMN: ColumnVehicle[] = [
  ...
  { id: 'u_wag', name: 'Pro-government infantry', roster: 'r_wagner', type: 'infantry', start: 16.5, killedAt: 49 },
];
...
export function demoScenario(): Scenario {
  return {
    ...
    factions: [
      ...
      { id: WAG, name: 'Pro-government force', color: '#cf5a50', affiliation: 'hostile' },
    ],
    units: [
      ...
      { id: 'u_m777', factionId: US, type: 'artillery', name: 'Marine M777 battery', rosterId: 'r_m777', lat: 35.367, lng: 40.42, heading: 225, appearAt: 0 },
      ...
      // --- US air response ---
      { id: 'u_f22a', factionId: US, type: 'air', name: 'F-22 Raptor', rosterId: 'r_f22', lat: 35.47, lng: 40.48, arrowId: 'a_f22a', appearAt: 20 },
      { id: 'u_f22b', factionId: US, type: 'air', name: 'F-22 Raptor', rosterId: 'r_f22', lat: 35.48, lng: 40.46, arrowId: 'a_f22b', appearAt: 21 },
    ...
    arrows: [
      ...COLUMN.map((v, i) => ({
        ...
        factionId: WAG,
        points: ROAD,
        name: i === 0 ? 'Pro-government advance' : `${v.name} follows`,
        appearAt: v.start,
        duration: ADVANCE_S,
      })),
      { id: 'a_f22a', factionId: US, points: [[40.48, 35.47], [40.39, 35.4], [40.32, 35.35]], name: 'F-22 defensive cover', appearAt: 20, duration: 8 },
      { id: 'a_f22b', factionId: US, points: [[40.46, 35.48], [40.37, 35.41], [40.3, 35.36]], name: 'F-22 defensive cover', appearAt: 21, duration: 8 },
      ...
      { id: 'a_ac130', factionId: US, points: [[40.4, 35.4], [40.35, 35.36], [40.3, 35.345], [40.265, 35.31], [40.27, 35.27]], name: 'AC-130 firing orbit', appearAt: 27, duration: 20 },
      { id: 'a_ah64a', factionId: US, points: [[40.4, 35.34], [40.36, 35.29], [40.31, 35.27]], name: 'AH-64 attack run', appearAt: 32, duration: 12 },
      { id: 'a_ah64b', factionId: US, points: [[40.41, 35.33], [40.37, 35.3], [40.322, 35.285]], name: 'AH-64 attack run', appearAt: 33, duration: 12 },
    ...
    labels: [
      ...
      { id: 'l_flag_ru', text: 'Reported Wagner PMC', flag: 'ru', lat: 35.288, lng: 40.268, size: 12, color: '#1c1f22', appearAt: 2 },
    ...
    strikes: [
      ...
      { id: 's_m777', lat: 35.304, lng: 40.3, name: '155mm coalition artillery', size: 0.65, salvo: 4, spreadM: 100, appearAt: 29, fromUnitId: 'u_m777', launchAt: 27.5 },
    ...
    // assault opens around 22:00 local; the column is broken and withdrawing a few hours later. Clear, cold night.
    environment: { startHour: 21.5, endHour: 2, date: '2018-02-07', utcOffset: 3, windDirDeg: 65, windKph: 14, haze: 0.15, cloudCover: 0 },
    effects: [
      ...
      { id: 'fx_counterbattery', kind: 'datalink', unitId: 'u_sf', targetUnitId: 'u_himars', start: 43, duration: 8, label: 'COUNTER-BATTERY' },
      // the column comes apart
      { id: 'fx_sdf_wounded', kind: 'wounded', unitId: 'u_sdf', start: 20.5, duration: 8, label: 'ONE FIGHTER WOUNDED' },
    ...
    keyframes: [
      {
        ...
        caption: 'On 7 February 2018, an uneasy boundary followed the Euphrates through eastern Syria.',
      },
      {
        id: 'k2', time: 5, lng: 40.322, lat: 35.314, zoom: 13.8, pitch: 48, bearing: -20,
        caption: 'At the Conoco gas plant, American special operators and Syrian Democratic Forces held the eastern bank.',
        highlightUnitIds: ['u_sf', 'u_sdf', 'u_sdf_tech', 'u_sdf_cp'],
      },
      {
        id: 'k3', time: 11, lng: 40.29, lat: 35.3, zoom: 13.2, pitch: 58, bearing: 25,
        followUnitId: 'u_t72a', followMode: 'chase',
        caption: 'That night, a pro-government column of tanks, fighting vehicles, and about 500 men moved out of Khasham, including reported Wagner personnel.',
        overlay: 'orbat', overlayFactionIds: [WAG], highlightUnitIds: COLUMN.map((v) => v.id),
      },
      {
        id: 'k4', time: 17, lng: 40.24, lat: 35.25, zoom: 13.1, pitch: 52, bearing: 35,
        caption: 'As the column closed on the plant, its howitzers and Grad rockets opened fire across the river.',
        highlightUnitIds: ['u_d30', 'u_grad'],
      },
      {
        id: 'k5', time: 24, lng: 40.35, lat: 35.33, zoom: 11.8, pitch: 52, bearing: -30,
        caption: 'American aircraft and artillery answered the call, including Raptors, Strike Eagles, a Reaper drone, a gunship, Apache helicopters, and B 52 bombers.',
        highlightUnitIds: ['u_m777', 'u_f22a', 'u_f22b', 'u_f15a', 'u_f15b', 'u_mq9', 'u_ac130', 'u_ah64a', 'u_ah64b', 'u_b52'],
      },
      {
        id: 'k6', time: 30, lng: 40.298, lat: 35.305, zoom: 13.7, pitch: 58, bearing: 10, orbitSpeed: 4,
        caption: 'One by one, precision strikes began tearing the advancing column apart.',
        highlightUnitIds: COLUMN.map((v) => v.id),
      },
      {
        id: 'k7', time: 39, lng: 40.294, lat: 35.302, zoom: 12.8, pitch: 58, bearing: 40, orbitSpeed: 2,
        followUnitId: 'u_ac130', followMode: 'track',
        caption: 'The A C 130 circled the battlefield, sending heavy shells into the column below.',
        highlightUnitIds: ['u_ac130', ...COLUMN.map((v) => v.id)],
      },
      {
        id: 'k8', time: 46, lng: 40.25, lat: 35.25, zoom: 13.1, pitch: 52, bearing: -15,
        caption: 'American rocket artillery turned on the attacking guns and silenced their remaining batteries.',
        highlightUnitIds: ['u_himars', 'u_d30', 'u_grad'],
      },
      {
        id: 'k9', time: 53, lng: 40.3, lat: 35.285, zoom: 11.5, pitch: 34, bearing: 0,
        caption: 'After about four hours, the assault had collapsed. No American troops were killed.',
        highlightUnitIds: ['u_sf', 'u_sdf', 'u_sdf_tech', 'u_sdf_cp'],
      },
    ],
  };
